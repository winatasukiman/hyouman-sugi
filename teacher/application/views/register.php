...
<div class="main">
	<div class="row" style="height:100vh;">
		...
		<div class="col-md-7 col-12 div_input d-flex justify-content-center align-items-center">
			<!-- <form> -->
			<?= form_open_multipart('register/add_user','id="form_register"') ?>
				<p class="login mt-5 mb-0">Register</p>
				<p class="login_marks">Let's get started!</p>
				<!-- Full Name -->
				<div class="form-group">
					...
					<div class="error" id="div_error_full_name">
				...
				<div class="form-group">
					...
					<div class="error" id="div_error_phone_number">
				...
				<div class="form-group">
					...
					<div class="error" id="div_error_email" style="margin-top: 10px;">
				...
				<div class="row">
					<div class="col-md-6 col-6">
						...
						<div class="form-group">
							...
							<div class="wrapper">
								<input type="password" placeholder="Create a password" id="password" name="password" maxlength="6" class="form-control" style="padding-right:40px;" />
							...
							<div class="error" id="div_error_password">
								<span id='error_password'>Minimum 6-digit number</span>
							</div>
						</div>
					</div>
					<div class="col-md-6 col-6">
						...
						<div class="form-group">
							...
							<div class="wrapper">
								...
								<span><i toggle="#confirm_password" class="fa fa-fw fa-eye-slash field-icon toggle-password"></i></span>
							</div>
				...
				<button class="mt-3" type="submit" id="register">Create Account</button>
				<p class="text_register mt-3">Do you already have an account ? 
				<a href="<?= base_url(); ?>login/">Log in here!</a></p>
