...
<style>
	...
	/* medium screen - for TAB 768px or less  */
			...
			<?= form_open_multipart('register/add_user','class="px-5" id="form_register"') ?>
				...
				<div class="row p-1">
					<button 
						...
						type="submit"
						id="register"
						style="background-color: #002448;border: none;border-radius: 8px;height:45px;margin-top:25px;">Sign Up</button>
				</div>
				...
				<div class="row p-1" style="margin-top:35px;">
