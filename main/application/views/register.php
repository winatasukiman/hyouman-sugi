...
<style>
	...
	@media screen and (max-width: 991px) {
		img{
			...
			width: 80%;
			margin-left: -15%;
			clip: rect(0px,510px,2000px,100px);
		}
	}
	/* medium screen - for TAB 767px or less  */
...
<div class="main">
	<div class="row" style="margin-top:-110px;">
		<div class="col-md-6">
			<img src="<?= base_url() ?>assets/img/signup/bgawal.png" class="img-fluid" alt="Responsive image">
		</div>
		<div class="col-12 col-md-6 divkanan">
			<!-- <form> -->
			<?= form_open_multipart('register/add_user','class="px-5" id="form_register"') ?>
				<p class="create_account mt-5 text-center">Create Account</p>
				<!-- Full Name -->
					...
					<div class="input-group">
						<div class="input-group" style="font-size: 13px;font-weight: 400;width:140px;">
							<select class="input-block-level" id="countryCode" name="countryCode" style="width:140px;">
								...
								<option data-countryCode="ID" value="62" selected="selected">&#x1F1EE&#x1F1E9 Indonesia (+62)</option>
				...
				<div class="form-group mb-3">
					<select class="browser-default custom-select input" style="color: black;"
						...
						<?php
						foreach ($user_type as $res) {
							if($res->user_type_id == 2 || $res->user_type_id == 3){
						?>
						<option
							value="<?= $res->user_type_id ?>">
							<?php if($res->user_type_name == "Child"){echo "Student";}else{ echo $res->user_type_name;} ?>
						</option>
							<?php }
						} ?>

					</select>
					<div class="text-center error" id="div_error_user_type" style="margin-top: 10px;">
						<span id='error_user_type'></span>
					</div>
				</div>
				<!-- Password -->
				<div class="form-group mb-3">
					<div class="input-group">
						<input 
							type="password" 
							placeholder="Password (6 Digits Number)" 
							style="color: black;" 
							id="password" 
							name="password" 
							class="form-control" />
					...
					<div class="text-center error" id="div_error_password" style="margin-top: 10px;">
				...
				<div class="row p-1">
					<button 
						...
						type="submit"
						id="register"
						style="background-color: #002448;border: none;border-radius: 8px;height:45px;margin-top:20px;">Sign Up</button>
				</div>

				<div class="mt-2 text-center">
					<hr align="left" style="border: 1px solid silver;width:170px;margin-top:35px;">
					<p class="sudahpunyakun">
						Have Any Account ?
					</p>
					<hr align="right" style="border: 1px solid silver;width:170px;margin-top:-26px;">
				</div>
				
				<div class="row p-1" style="margin-top:35px;margin-bottom: 40px;">
