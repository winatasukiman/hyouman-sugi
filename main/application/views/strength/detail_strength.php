		...
		<div id="div_strength_capture" style="padding-left:25px;">
			...
			<div class="row mt-4">
				<div class="col-md-6 col-12">
					<p><b><?= $ssd->strength_capture_inisial?></b>&nbsp;&nbsp;<?= $ssd->strength_capture_name?>&nbsp;&nbsp;&nbsp;<?php if($ssd->strength_capture_detail_id != null){ ?><img src="<?= base_url()?>assets/img/icon/check.png" class="img-fluid"><?php } ?><p>
				</div>
				<div class="col-md-3 col-6">
					<?php if($strength_student->user_id == $this->session->userdata('user_id')){ ?>
					<button 
						type="button" 
						...
						style="color: white;width: 100%;margin:auto;">Capture Activities</button>
					<?php }?>
				</div>
				<div class="col-md-3 col-6">
			...
			<div id="div_content<?= $ssd->strength_student_detail_id?>" class="div_content">
				...
				<div class="row mt-5 div_content_ss">
					<div class="col-md-2" style="padding:0;">
						...
						<img src="<?= base_url()?><?= $ssd->strength_student_detail_file[0]->file_path ?>" class="img-fluid" alt="Responsive image">
						<?php } ?>
					</div>
					<div class="col-md-7">
				...
				<div class="row mt-5 div_content_ss">
					<div class="col-md-2" style="padding:0;">
						...
						<img src="<?= $this->config->item('teacher_url') ?>/<?= $ssdr->strength_student_detail_review_file[0]->file_path ?>" class="img-fluid" alt="Responsive image">
						<?php } ?>
					</div>
					<div class="col-md-7">
						<p>Review from teacher <?= $ssdr->teacher_name ?><p>
      ...
      <div class="modal-body">
		...
		<div class="row">
			...
			<div class="col-md-4 col-4">
				<img src="<?= base_url()?><?= $ssdf->file_path ?>" class="img-fluid" alt="Responsive image">
			</div>
			<?php }?>
		</div>
      </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
			...
			<div class="col-md-4 col-4">
				<img src="<?= $this->config->item('teacher_url') ?>/<?= $ssdrf->file_path ?>" class="img-fluid" alt="Responsive image">
			</div>
			<?php }?>
		</div>
      </div>
