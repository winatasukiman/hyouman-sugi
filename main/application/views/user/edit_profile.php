			...
			<div class="col-md-12 text-left">
				<div class="row">
					<div class="col-md-4">
						...
						<!-- <?php if($data_array->user_type_id == 3 ){ //Child View
							if($data_array->status_class_joined == 2 ){ //Only status class finished if want to change grade?>
						<!-- Grade -->
						<div class="form-group mb-3up">
							<label class="label" for="Grade">Grade</label>
							<div class="input-group">
								<select class="browser-default custom-select input" style="color: black;" id="grade" name="grade" <?php if($data_array->status_class_joined != 2 ){ echo "disabled";} ?>>
									...
									?>
										<option
											value="<?= $grade[$i]->grade_id ?>" <?php if($grade_user!=null){if($grade_user->grade_id == $grade[$i]->grade_id) echo 'selected="selected"';} ?>>
											<?= $grade[$i]->grade_name ?>
										</option>
									<?php } ?>
								</select>
						...
						<?php }else{ ?>
						<div class="form-group mb-3up">
							<div class="text-center error" style="margin-top: 10px;text-align:center;">
								<span>The class must finished before change grade</span>
							</div>
						</div>	
						<?php }
						}?> -->
						...
						<!--<div class="form-group mb-3up">
							...
							<input 
								...
								id="nik" 
								name="nik"
								placeholder="NIK / KITAS"
								value="<?= $data_array->province ?>"/>
							<div class="text-center error" id="div_error_nik" style="margin-top: 10px;">
						...
						<!--<div class="form-group mb-3up">
							...
							<select class="browser-default custom-select input" style="color: black;" id="religion" name="religion">
								...
								<option value="konghusu">Konghucu</option>
								<option value="kepercayaan kepada Tuhan YME">Kepercayaan kepada Tuhan YME</option>
								<option value="lainnya">Lainnya</option>
							</select>
							<div class="text-center error" id="div_error_religion" style="margin-top: 10px;">
								<span id='error_religion'></span>
							</div>
						</div>-->
						<!-- Gender -->
						<!--<fieldset class="form-group">
							<div class="">
								<label class="label" for="custom-control-label label">Kewarganegaraan &emsp;</label><br>-->
								<!-- Radio Button WNI -->
								<!--<div class="custom-control custom-radio custom-control-inline">
									<input 
										...
										/>
									<label class="custom-control-label label" for="user_gender_male">WNI</label>
								</div><br>-->
								<!-- Radio Button WNA -->
								<!--<div class="custom-control custom-radio custom-control-inline">
									<input 
										...
										/>
									<label class="custom-control-label label" for="wna">WNA</label>
								</div>
							</div>
						...
						<!--<div class="form-group mb-3up">
							...
							<select class="browser-default custom-select input" style="color: black;" id="berkebutuhan_khusus" name="berkebutuhan_khusus">
							...
							<div class="text-center error" id="div_error_berkebutuhan_khusus" style="margin-top: 10px;">
								<span id='error_berkebutuhan_khusus'></span>
							</div>
						</div>-->
						<!-- Tempat tinggal -->
						<!--<div class="form-group mb-3up">
							...
							<select class="browser-default custom-select input" style="color: black;" id="tempat_tinggal" name="tempat_tinggal">
								<option disabled selected>Choose Option</option>
							...
							<div class="text-center error" id="div_error_tempat_tinggal" style="margin-top: 10px;">
								<span id='error_tempat_tinggal'></span>
							</div>
						</div>-->
					</div>
					<div class="col-md-4">
